...
public class BasePage {
	...
	// instanciando
	//private WebDriver driver;  //sendo colocado nesta parte do codigo, a variavel driver passa a ser variavel global.

	// caminho no menu para gerar este metodo automaticamente >botao direito mouse > source > generater constructor using fields
	// na janela, selecione o campo (driver no caso) e clique em generate
	...
	public void selecionarCombo(String id, String valor) {
		...
		//combo.selectByIndex(valor); // seleciona o terceiro elemento do combo, lembrando q o indice começa no zero
